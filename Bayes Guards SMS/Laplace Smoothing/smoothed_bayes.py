...
class SmoothedNaiveBayes:
    ...
    def predict(self, X):
        ...
        # X = split_by_words(X)
        #
        # # For each message, find the unique words and create an array of zeros of the appropriate size
        # for message in X:
        #     unique = np.unique(message)
        #     index_array = # TODO
        #
        #     # For each unique word, look it up in the dictionary and store its index in the array.
        #     # If it is not there, assign it the index equal to the length of the dictionary.
        #     for i, word in enumerate(unique):
        #         word_index = # TODO
        #         index_array[i] = word_index
        #
        #     # Slice the likelihood array to keep only the words that appear in the current message
        #     # and apply the logarithm to compute the log-likelihood.
        #     log_likelihood = # TODO
        #     # Refer to the formula and hints in the text to calculate the posterior probability
        #     # For each class, select the one with the highest probability and append it to the result
        #     posterior = # TODO
        #     predicted = # TODO
