...
```
The variables required for this code to function correctly were introduced in previous steps. If you haven't worked with `task.py` yet, pay attention to them:
```python
