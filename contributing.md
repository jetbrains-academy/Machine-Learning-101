...
This repository contains the source material for the Introduction to Machine Learning course.

# Contributing
We love contributions!
We welcome fixes for existing bugs, as well as corrections for task and test mistakes.
The current tasks can be found in the [open issues](https://github.com/jetbrains-academy/Machine-Learning-101/issues) section of the project.
...
to the `master` branch via [GitHub Pull requests](https://github.com/jetbrains-academy/Machine-Learning-101/pulls).
...
-[ ] You've made sure that all tests in [GitHub Actions](https://github.com/jetbrains-academy/Machine-Learning-101/tree/master/.github/workflows) pass
